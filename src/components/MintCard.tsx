...
export const MintCard = () => {
  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-6 shadow-[0_25px_65px_-45px_rgba(236,72,153,0.7)]">
      ...
      <form className="relative space-y-6" onSubmit={handleSubmit}>
        <header className="flex flex-col gap-2">
          ...
          <h2 className="text-2xl font-semibold text-white">Convert DOT → vDOT</h2>
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between text-xs text-purple-100/80">
            <span>Amount</span>
            <span>Available: {dotAvailableDisplay} DOT</span>
          </div>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              className="rounded-full border border-purple-400/50 bg-purple-500/20 px-3 py-1 text-xs font-semibold text-white transition hover:border-purple-300 hover:bg-purple-500/30"
            >
              Max
            </button>
          </div>
