...
function App() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950 text-white">
      ...
      <main className="relative mx-auto flex max-w-6xl flex-col gap-8 px-6 pb-16 pt-10 sm:px-10">
        <Header />
        <BalanceCard />
        ...
        <footer className="mt-4 flex flex-col items-start gap-1 text-xs text-white/50 sm:flex-row sm:items-center sm:justify-between">
