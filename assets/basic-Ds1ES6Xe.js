import{i as N,e as G,r as q,c as O,x as c,j as M,m as z,O as ee,o as j,E as te,R as U,z as Me,f as K,B as k,D as ft,q as yi,W as pt,C as Xt,g as vn,T as Zt,l as Xe,M as ni,F as ii,b as Ne,v as yn,d as xi}from"./core-BFyigqFL.js";import{n as u,c as T,o as W,r as I,U as he,e as Ci,f as $i,a as Ri}from"./index-aS_kQOnM.js";import{r as Ii,p as Ei}from"./index-BFRLSihB.js";import"./index.es-DgggS3nf.js";import"./events-DQ172AOg.js";const Wi=N`
  :host {
    position: relative;
...
`;var $o=function(r,e,n,i){var o=arguments.length,t=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,n):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(r,e,n,i);else for(var s=r.length-1;s>=0;s--)(a=r[s])&&(t=(o<3?a(t):o>3?a(e,n,t):a(e,n))||t);return o>3&&t&&Object.defineProperty(e,n,t),t};let tn=class extends V{constructor(){super(),this.forceUpdate=()=>{this.requestUpdate()},window.addEventListener("resize",this.forceUpdate),te.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:this.wallet?.name??"WalletConnect",platform:"qrcode"}})}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribe?.forEach(e=>e()),window.removeEventListener("resize",this.forceUpdate)}render(){return this.onRenderProxy(),c`
    ...
    ></wui-flex>`}};hi([I()],on.prototype,"isMobile",void 0);on=hi([T("w3m-connecting-wc-basic-view")],on);/**
 * @license
